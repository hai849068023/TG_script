...
with open('secret.txt', 'r') as f:
    ...
    pwd = secret[1]
login_page = tg.get('https://m3.tg6666.net/lmarketlistogin.php', verify=False)
        ...
        for market in marketlist[:5]:
            ...
            try:
                halfscore_odds_txted = sorted(halfscore_odds_txt,
                                              ...
                                              reverse=True)
                number = random.choice(halfscore_odds_txted[1:4]).replace('\n', '')
            except:
                continue

            # buy_score = number[:5]
            buy_score = random.choice(['2 - 1', '2 - 0', '1 - 2', '0 - 2'])
